			...
			<div className='flex items-start justify-between'>
				<div className='flex flex-col gap-0.5'>
					...
					<div className='flex items-center gap-3'>
						...
						<p className='text-xl font-bold tracking-tight text-gray-600 dark:text-gray-50'>
							<span className='font-medium mr-0.5'>$</span>
							{total.toLocaleString()}
						</p>
					</div>
				</div>
				<BarChart2 className='size-5 text-violet-500 dark:text-pink-400 mt-1' />
			</div>

			<div className='flex flex-col gap-2 p-4 rounded-xl bg-white/80 dark:bg-gray-800/60 flex-grow justify-center'>
				<p className='text-xs uppercase font-medium tracking-wider text-gray-600 dark:text-gray-400'>
					...
					<div className='flex items-baseline gap-2'>
						<div
							className={`flex items-center justify-center size-8 rounded-lg ${
								trendUp ? 'bg-violet-200/75' : 'bg-pink-200/75'
			...
			<div className='flex justify-between gap-4'>
				<div className='flex flex-col gap-1 w-1/2 p-3 rounded-lg bg-white/50 dark:bg-gray-800/35'>
					<div className='flex items-center gap-2'>
						...
						<p className='text-sm font-medium text-violet-400 dark:text-violet-300'>
							Income
						</p>
					</div>
					<p className='text-lg font-semibold text-gray-600 dark:text-gray-200 pl-7'>
						<span className='font-medium mr-0.5'>$</span>
